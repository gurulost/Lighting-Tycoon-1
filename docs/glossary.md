# Lighting Tycoon Glossary

Use this as a quick reference for every icon, badge, and system.

## Parts (Open Standard)
- Clip (Open): starter part for open builds.
- Track (Open): tier 2 run.
...
- Style Match: all Open or all Locked.
